...
const existingClinic: ClinicRow = {
  ...
  receipt: {}, receiptFooter: '', logoUrl: '', telegramHandle: '', receiptQr: true, receiptNextVisit: true,
...
const serverClinic: ClinicWire = {
  ...
  receipt: {}, receipt_footer: 'See you', logo_url: '', telegram_handle: '', receipt_qr: false, receipt_next_visit: false,
